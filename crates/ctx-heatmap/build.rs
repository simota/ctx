// crates/ctx-heatmap/build.rs — emit include/ctx_heatmap.h.
...
fn main() {
    ...
    let out_path = PathBuf::from(out_dir).join("ctx_heatmap.h");
    ...
    match builder.generate() {
        Ok(bindings) => {
            ...
            let stable_path = stable_dir.join("ctx_heatmap.h");
