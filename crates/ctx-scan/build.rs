...
//
// Phase 1 FFI shim: emit a C99 header (`include/ctx_scan.h`) describing
...
fn main() {
    ...
    let out_path = PathBuf::from(out_dir).join("ctx_scan.h");
    ...
    match builder.generate() {
        Ok(bindings) => {
            ...
            let stable_path = stable_dir.join("ctx_scan.h");
